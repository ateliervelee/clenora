...
const STRINGS = {
    ...
    // Hero
    hero_title: 'Professional Apartment Cleaning Services',
    hero_subtitle: 'Trusted, eco-friendly cleaning solutions for your home. We make your space spotless, so you can focus on what matters.',
    ...
    services_apartment_title: 'Apartment Cleaning',
    services_apartment_desc: 'Do you have guests coming and need the place to shine? We got you covered with our reliable cleaning that will make your guests feel right at home.',
    ...
    services_regular_desc: 'Weekly or bi-weekly cleaning to keep your apartment consistently clean and fresh.',
    services_move_title: 'Move-In/Out Cleaning',
    services_move_desc: 'Complete cleaning service for when you\'re moving in or out of your apartment.',
    services_window_title: 'Window Cleaning',
    services_window_desc: 'Sparkling clean windows inside and out for a brighter living space.',
    services_kitchen_title: 'Kitchen Deep Clean',
    services_kitchen_desc: 'Detailed cleaning of appliances, cabinets, countertops, and all kitchen surfaces.',
    services_bathroom_title: 'Bathroom Sanitization',
    services_bathroom_desc: 'Complete sanitization and cleaning of all bathroom fixtures and surfaces.',
    ...
    form_option_apartment: 'Apartment Cleaning',
